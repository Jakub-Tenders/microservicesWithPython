...
You built a service with three distinct layers: domain (models), application (schemas + service), infrastructure (repository + database).
...
You now have models, schemas, repositories, and a service class — four layers for what is essentially a CRUD service.
